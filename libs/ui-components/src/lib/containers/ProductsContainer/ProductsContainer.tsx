...
import { useFilteredProducts } from '@fruit-shop/hooks';
...
export const ProductsContainer = () => {
    ...
    const { data: products = [], isLoading, isFetching, error } = useFilteredProducts(filters);
                ...
                <div className="lg:col-span-3">
                    {isFetching && products.length === 0 ? (
                        ...
                        <div className="relative">
                            {isFetching && (
                                <div className="absolute top-0 left-0 right-0 bg-white bg-opacity-75 flex items-center justify-center py-4 z-10">
                                    <Spinner size="sm" />
                                    <span className="ml-2 text-gray-600">Filtering products...</span>
                                </div>
                            )}
